...
import type { ModuleAsset, ModuleAssetStore } from "../types/researchArtifacts.js";
...
export class ResearchModuleAssetService {
  ...
  async extract(input: { url: string; contextTitle?: string | undefined; selectedPaths?: string[] | undefined }): Promise<ModuleAsset> {
    ...
    const selectedPaths = (input.selectedPaths && input.selectedPaths.length > 0
      ? input.selectedPaths
